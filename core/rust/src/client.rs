...
fn client_config_to_options(client_config: ClientConfig) -> ClientOptions {
    let tls_cfg = client_config.tls_config.map(|tls_config| TlsOptions {
    ...
    let retry_opts = client_config.retry_config.map(|rc| RetryOptions {
    ...
    ClientOptions::builder()
        ...
        .maybe_retry_options(retry_opts)
