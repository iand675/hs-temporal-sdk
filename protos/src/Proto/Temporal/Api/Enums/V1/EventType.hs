...
instance Data.ProtoLens.MessageEnum EventType where
  ...
  maybeToEnum 47
    = Prelude.Just EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED
  maybeToEnum 48 = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_SCHEDULED
  maybeToEnum 49 = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_STARTED
  maybeToEnum 50 = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_COMPLETED
  maybeToEnum 51 = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_FAILED
  maybeToEnum 52 = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_CANCELED
  maybeToEnum 53 = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT
  maybeToEnum 54
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED
  maybeToEnum 55
    = Prelude.Just EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED
  maybeToEnum 56
  ...
  showEnum EVENT_TYPE_UPSERT_WORKFLOW_SEARCH_ATTRIBUTES
    = "EVENT_TYPE_UPSERT_WORKFLOW_SEARCH_ATTRIBUTES"
  showEnum EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED
    = "EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED"
  ...
  showEnum EVENT_TYPE_WORKFLOW_PROPERTIES_MODIFIED
    = "EVENT_TYPE_WORKFLOW_PROPERTIES_MODIFIED"
  showEnum EVENT_TYPE_NEXUS_OPERATION_SCHEDULED
    = "EVENT_TYPE_NEXUS_OPERATION_SCHEDULED"
  showEnum EVENT_TYPE_NEXUS_OPERATION_STARTED
    = "EVENT_TYPE_NEXUS_OPERATION_STARTED"
  showEnum EVENT_TYPE_NEXUS_OPERATION_COMPLETED
    = "EVENT_TYPE_NEXUS_OPERATION_COMPLETED"
  showEnum EVENT_TYPE_NEXUS_OPERATION_FAILED
    = "EVENT_TYPE_NEXUS_OPERATION_FAILED"
  showEnum EVENT_TYPE_NEXUS_OPERATION_CANCELED
    = "EVENT_TYPE_NEXUS_OPERATION_CANCELED"
  showEnum EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT
    = "EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT"
  showEnum EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED
    = "EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED"
  showEnum EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED
    = "EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED"
  showEnum EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUEST_COMPLETED
    = "EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUEST_COMPLETED"
  ...
  readEnum k
    ...
    = Prelude.Just EVENT_TYPE_UPSERT_WORKFLOW_SEARCH_ATTRIBUTES
    | (Prelude.==) k "EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED"
    = Prelude.Just EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED
    ...
    = Prelude.Just EVENT_TYPE_WORKFLOW_PROPERTIES_MODIFIED
    | (Prelude.==) k "EVENT_TYPE_NEXUS_OPERATION_SCHEDULED"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_SCHEDULED
    | (Prelude.==) k "EVENT_TYPE_NEXUS_OPERATION_STARTED"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_STARTED
    | (Prelude.==) k "EVENT_TYPE_NEXUS_OPERATION_COMPLETED"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_COMPLETED
    | (Prelude.==) k "EVENT_TYPE_NEXUS_OPERATION_FAILED"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_FAILED
    | (Prelude.==) k "EVENT_TYPE_NEXUS_OPERATION_CANCELED"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_CANCELED
    | (Prelude.==) k "EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT
    | (Prelude.==) k "EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED
    | (Prelude.==) k "EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED"
    = Prelude.Just EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED
    | (Prelude.==)
        k "EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUEST_COMPLETED"
    = Prelude.Just EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUEST_COMPLETED
...
instance Prelude.Enum EventType where
  ...
  fromEnum EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED = 47
  fromEnum EVENT_TYPE_NEXUS_OPERATION_SCHEDULED = 48
  fromEnum EVENT_TYPE_NEXUS_OPERATION_STARTED = 49
  fromEnum EVENT_TYPE_NEXUS_OPERATION_COMPLETED = 50
  fromEnum EVENT_TYPE_NEXUS_OPERATION_FAILED = 51
  fromEnum EVENT_TYPE_NEXUS_OPERATION_CANCELED = 52
  fromEnum EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT = 53
  fromEnum EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED = 54
  ...
  succ EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED
    = EVENT_TYPE_NEXUS_OPERATION_SCHEDULED
  succ EVENT_TYPE_NEXUS_OPERATION_SCHEDULED
    = EVENT_TYPE_NEXUS_OPERATION_STARTED
  succ EVENT_TYPE_NEXUS_OPERATION_STARTED
    = EVENT_TYPE_NEXUS_OPERATION_COMPLETED
  succ EVENT_TYPE_NEXUS_OPERATION_COMPLETED
    = EVENT_TYPE_NEXUS_OPERATION_FAILED
  succ EVENT_TYPE_NEXUS_OPERATION_FAILED
    = EVENT_TYPE_NEXUS_OPERATION_CANCELED
  succ EVENT_TYPE_NEXUS_OPERATION_CANCELED
    = EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT
  succ EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT
    = EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED
  succ EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED
    = EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED
  succ EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED
    = EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUEST_COMPLETED
  ...
  pred EVENT_TYPE_WORKFLOW_PROPERTIES_MODIFIED
    = EVENT_TYPE_ACTIVITY_PROPERTIES_MODIFIED_EXTERNALLY
  pred EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED
    = EVENT_TYPE_WORKFLOW_PROPERTIES_MODIFIED
  pred EVENT_TYPE_NEXUS_OPERATION_SCHEDULED
    = EVENT_TYPE_WORKFLOW_EXECUTION_UPDATE_ADMITTED
  pred EVENT_TYPE_NEXUS_OPERATION_STARTED
    = EVENT_TYPE_NEXUS_OPERATION_SCHEDULED
  pred EVENT_TYPE_NEXUS_OPERATION_COMPLETED
    = EVENT_TYPE_NEXUS_OPERATION_STARTED
  pred EVENT_TYPE_NEXUS_OPERATION_FAILED
    = EVENT_TYPE_NEXUS_OPERATION_COMPLETED
  pred EVENT_TYPE_NEXUS_OPERATION_CANCELED
    = EVENT_TYPE_NEXUS_OPERATION_FAILED
  pred EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT
    = EVENT_TYPE_NEXUS_OPERATION_CANCELED
  pred EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED
    = EVENT_TYPE_NEXUS_OPERATION_TIMED_OUT
  pred EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED
    = EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUESTED
  pred EVENT_TYPE_NEXUS_OPERATION_CANCEL_REQUEST_COMPLETED
    = EVENT_TYPE_WORKFLOW_EXECUTION_OPTIONS_UPDATED
